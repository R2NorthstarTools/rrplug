...
pub struct CPlayerDecoy {
    ...
    pub m_currentState: i32,        // +0xeb8 size: 0x4 (0x1 * 0x4) type 5
    pub m_decoyFlags: i32,          // +0xebc size: 0x4 (0x1 * 0x4) type 5
    pub m_lastPulseTime: f32,       // +0xec0 size: 0x4 (0x1 * 0x4) type 16
    pub m_previousState: i32,       // +0xec4 size: 0x4 (0x1 * 0x4) type 5
    pub m_deathTime: f32,           // +0xec8 size: 0x4 (0x1 * 0x4) type 16
    pub m_removeTime: f32,          // +0xecc size: 0x4 (0x1 * 0x4) type 16
    pub m_npcSoundTime: f32,        // +0xed0 size: 0x4 (0x1 * 0x4) type 16
    pub m_npcSoundIndex: i32,       // +0xed4 size: 0x4 (0x1 * 0x4) type 5
    pub m_fakeWeapon: EHandle,      // +0xed8 size: 0x4 (0x1 * 0x4) type 13
    pub m_stowedWeapon: EHandle,    // +0xedc size: 0x4 (0x1 * 0x4) type 13
    pub m_runSpeed: f32,            // +0xee0 size: 0x4 (0x1 * 0x4) type 1
    pub m_sprintSpeed: f32,         // +0xee4 size: 0x4 (0x1 * 0x4) type 1
    pub m_jumpHeight: f32,          // +0xee8 size: 0x4 (0x1 * 0x4) type 1
    pub m_wallrunJumpStrength: f32, // +0xeec size: 0x4 (0x1 * 0x4) type 1
    pub m_jumpTime: f32,            // +0xef0 size: 0x4 (0x1 * 0x4) type 16
    pub m_nextFlickerTime: f32,     // +0xef4 size: 0x4 (0x1 * 0x4) type 16
    pub m_flickerRate: f32,         // +0xef8 size: 0x4 (0x1 * 0x4) type 1
    pub m_curSpeed: f32,            // +0xefc size: 0x4 (0x1 * 0x4) type 1
    pub m_slideEndTime: f32,        // +0xf00 size: 0x4 (0x1 * 0x4) type 16
    pub m_animEndTime: f32,         // +0xf04 size: 0x4 (0x1 * 0x4) type 16
    pub m_decoyHeight: f32,         // +0xf08 size: 0x4 (0x1 * 0x4) type 1
    pub m_pulseRate: f32,           // +0xf0c size: 0x4 (0x1 * 0x4) type 1
    pub m_nextPulseTime: f32,       // +0xf10 size: 0x4 (0x1 * 0x4) type 16
    pub m_upDir: Vector3,           // +0xf14 size: 0xc (0x1 * 0xc) type 3
    pub modifiers: [u8; 64],        // +0xf20 size: 0x40 (0x1a * 0x2) type 31
}
